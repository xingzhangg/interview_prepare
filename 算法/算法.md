...
* [二、算法分析](#二算法分析)
    ...
    * [倍率实验](#倍率实验)
* [三、排序](#三排序)
    * [选择排序](#选择排序)（需要掌握）平均复杂度： O(n2)
    * [冒泡排序](#冒泡排序)（需要掌握）平均复杂度： O(n2)
    * [插入排序](#插入排序)（需要掌握）平均复杂度： O(n2)
    * [希尔排序](#希尔排序)O(n*logn)
    * [归并排序](#归并排序) （需要掌握）O(n*logn)
    * [快速排序](#快速排序)（需要掌握）O(n*logn) 稳定
    * [堆排序](#堆排序)（需要掌握）O(n*logn)
    * [小结](#小结)
* [四、并查集](#四并查集)
...
在一轮循环中，如果没有发生交 换，就说明数组已经是有序的，此时可以直接退出。
