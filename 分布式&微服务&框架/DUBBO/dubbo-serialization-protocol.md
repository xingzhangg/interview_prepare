...
![serialize-deserialize](../pics/serialize-deserialize.png)
...
![dubbo-keep-connection](../pics/dubbo-keep-connection.png)

而短连接，每次要发送请求之前，需要先重新建立一次连接。

![dubbo-not-keep-connection](../pics/dubbo-not-keep-connection.png)
